...
public class Prescription {
    ...
    public Prescription(int id, int prescriptionId, int drugId, String drugName, String drugType, String drugDose, String drugDuration, String drugStrength, String drugAdvice) {
        this.id = id;
